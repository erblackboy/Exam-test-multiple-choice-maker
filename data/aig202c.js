const aig202c_questions = [
    {
        ...
        options: [
            "A. Self-driving vehicles utilizing Computer Vision to navigate around objects",
            "B. Classifying rock samples to identify best places to drill for oil",
    ...
    {
        id: "aig202c_002",
        question: "Why is clarity important when writing prompts for generative AI models?",
        options: [
            "A. Clarity helps make the prompt less engaging",
            "B. Clarity helps the model understand the task and produce relevant responses",
    ...
    {
        id: "aig202c_003",
        question: "Which of the following aspects involved in converting the stethoscope into a digital device to support patient diagnoses involves the use of AI?",
        options: [
            "A. An app on the mobile device that applies learnings from previous diagnosis data to assist physicians",
            "B. Sending digital signals to a mobile device with a machine learning app via Bluetooth",
    ...
    {
        id: "aig202c_004",
        question: "Which concern in AI focuses on avoiding biased decision-making in algorithms?",
        options: [
            "A. AI Transparency",
            "B. AI Ethics",
            "C. AI Accountability",
    ...
    {
        id: "aig202c_005",
        question: "What is a significant way in which developers of AI systems can guard against introducing bias?",
        options: [
            "A. Using only examples from their own environment as training data",
            "B. Using less varied AI systems and datasets",
    ...
    {
        id: "aig202c_006",
        question: "Ethics in artificial intelligence is:",
        options: [
            "A. Something that is not an issue",
            "B. Something that is entirely solved in current AI systems",
    ...
    {
        id: "aig202c_007",
        question: "Which of the following is NOT a common strategy for managing digressions in chatbots?",
        options: [
            "A. Redirecting the conversation back to the original topic",
            "B. Ignoring the user's input and continuing with a predefined script",
    ...
    {
        id: "aig202c_008",
        question: "Why are 'digressions' employed within chatbot conversations?",
        options: [
            "A. To confuse users intentionally",
            "B. To enhance natural and engaging conversations",
    ...
    {
        id: "aig202c_009",
        question: "Which of the following is an attribute of Supervised Learning?",
        options: [
            "A. Relies on providing unlabeled data and letting the machine infer qualities",
            "B. Tries to maximize rewards by trying different combinations of allowed actions",
    ...
    {
        id: "aig202c_010",
        question: "Tiana is designing a game and decides to create one avatar with specific personality traits. What type of generative AI capability is Tiana using?",
        options: [
    ...
    {
        id: "aig202c_011",
        question: "Which of the following is the main purpose of using the user feedback loop?",
        options: [
            "A. To iteratively refine text prompts based on the response generated by the LLM",
            "B. To generate responses with examples",
    ...
    {
        id: "aig202c_012",
        question: "Rachel wants to apply prompt engineering to create creative ideas for a marketing campaign of a new eco-friendly home cleaning product. Identify the best prompt for this task.",
        options: [
            "A. List the benefits of the new eco-friendly home cleaning product through campaigns",
            "B. Generate ideas to sell a new product in the digital market through marketing campaigns",
    ...
    {
        id: "aig202c_013",
        question: "Which of the following are examples of bias in an AI system?",
        options: [
            "A. Facial recognition systems performing well for all skin tones",
            "B. Image recognition systems associating kitchens with women rather than men",
    ...
    {
        id: "aig202c_014",
        question: "Which of these are attributes of IBM's Cognitive APIs?",
        options: [
            "A. Based on an input/output system where data is fed into Watson for outcomes",
            "B. Can process only structured data as input and unstructured data as output",
    ...
    {
        id: "aig202c_015",
        question: "Using a generative AI tool, Emily wants to create an image of a zebra-striped cat with a purple hat. Identify the best prompt for this task.",
        options: [
            "A. List cat breeds that look like zebras or have stripes",
            "B. Draw an image of a zebra-striped cat with a purple hat",
    ...
    {
        id: "aig202c_016",
        question: "What impact do well-implemented 'digressions' have on chatbot conversations?",
        options: [
            "A. Limiting conversational options for users",
            "B. Enhancing natural conversation and user engagement",
    ...
    {
        id: "aig202c_017",
        question: "How do chatbots use entities to understand user queries and provide relevant responses?",
        options: [
            "A. By matching detected entities to predefined actions or responses",
            "B. By ignoring entities and focusing only on user intent",
    ...
    {
        id: "aig202c_018",
        question: "How does AI contribute to environmental conservation and sustainability?",
        options: [
            "A. Accelerating climate change impacts",
            "B. Optimizing energy usage and waste reduction",
    ...
    {
        id: "aig202c_019",
        question: "What does AI Accountability entail in the context of ethical AI?",
        options: [
            "A. The responsibility of AI developers and users for AI actions",
            "B. The secrecy of AI algorithms",
    ...
    {
        id: "aig202c_020",
        question: "How can prompt engineering be used to mitigate biases in AI models?",
        options: [
            "A. By generating prompts automatically using AI algorithms",
            "B. By ensuring prompts encourage diverse and inclusive responses",
    ...
    {
        id: "aig202c_021",
        question: "Which of the following is NOT a potential challenge associated with prompt engineering?",
        options: [
            "A. Limited control over the output of AI models",
            "B. Difficulty in generating prompts automatically using AI algorithms",
    ...
    {
        id: "aig202c_022",
        question: "How are 'slots' used in the context of chatbot interactions?",
        options: [
            "A. To identify network vulnerabilities",
            "B. To manage and capture specific pieces of information from users",
    ...
    {
        id: "aig202c_023",
        question: "What is an example of AI's role in improving customer service and experiences?",
        options: [
            "A. Lengthening response times and delays",
            "B. Providing personalized recommendations and support",
    ...
    {
        id: "aig202c_024",
        question: "If one of a paired punctuation such as parentheses is missing:",
        options: [
            "A. The robot will assume that it is there and continue running",
    ...
    {
        id: "aig202c_025",
        question: "Which of the following demonstrates an application of Artificial Intelligence in action?",
        options: [
            "A. IBM Watson assisting oil and gas workers with technical information retrieval",
            "B. Analyzing emotions in Grammy-nominated song lyrics using AI",
    ...
    {
        id: "aig202c_026",
        question: "How is Watson currently aiding in solving business problems?",
        options: [
            "A. Gathering expertise from thousands of employees to reduce time spent tracking knowledge",
            "B. Using sensor data to detect moisture levels for irrigation systems",
    ...
    {
        id: "aig202c_027",
        question: "Advances in the field of Computer Vision make which of the following possible?",
        options: [
            "A. Real-time transcription",
            "B. Detecting cancerous moles in skin images",
    ...
    },
    {
        ...
        options: [
            "A. Operate with human-level consciousness",
            "B. Cannot teach itself new strategies",
    ...
    {
        id: "aig202c_029",
        question: "How are intents used in natural language understanding for chatbots?",
        options: [
            "A. To detect the emotion of the user",
            "B. To identify the language being spoken",
    ...
    {
        id: "aig202c_030",
        question: "What type of learning involves AI systems learning from data without explicit programming?",
        options: [
    ...
    {
        id: "aig202c_031",
        question: "Which of the following is a concern regarding AI Transparency?",
        options: [
            "A. The inability to understand AI algorithms",
            "B. The clarity in AI decision-making processes",
    ...
    {
        id: "aig202c_032",
        question: "What does generative AI do differently than discriminative AI?",
        options: [
            "A. Mimics the human ability to predict data",
            "B. Mimics the human ability to analyze data",
    ...
    {
        id: "aig202c_033",
        question: "Which of the following statements about datasets used in Machine Learning is NOT true?",
        options: [
            "A. Validation data subset is used to validate results and fine-tune parameters",
            "B. Training data is used to fine-tune parameters and evaluate model performance",
    ...
    {
        id: "aig202c_034",
        question: "Which of the following is a potential challenge associated with prompt engineering for generative AI?",
        options: [
            "A. Limited control over the output of generative AI models",
            "B. Difficulty in training generative AI models without prompts",
            "C. Lack of available tools and resources for prompt engineering",
    ...
    {
        id: "aig202c_035",
        question: "What role does human input play in prompt engineering?",
        options: [
            "A. Human input is not necessary for prompt engineering",
            "B. Human input is essential for designing effective prompts and evaluating outputs",
    ...
    {
        id: "aig202c_036",
        question: "Which of the following is not a stage in the AI Project Cycle?",
        options: [
            "A. Problem Scoping",
            "B. Data Exploration",
            "C. Data Acquisition",
    ...
    {
        id: "aig202c_037",
        question: "How can 'digressions' within chatbot conversations be effectively balanced to ensure optimal user engagement?",
        options: [
            "A. By avoiding deviations entirely to maintain a focused conversation",
            "B. By implementing random conversation paths for unpredictability",
    ...
    {
        id: "aig202c_038",
        question: "Which concept does the introduction module primarily cover in chatbot development without programming?",
        options: [
            "A. Complex algorithms in cryptography",
            "B. Front-end web development techniques",
    ...
    {
        id: "aig202c_039",
        question: "How are 'entities' utilized in AI-powered chatbots?",
        options: [
            "A. Understanding complex mathematical algorithms",
            "B. Identifying and extracting specific information from user inputs",
    ...
    {
        id: "aig202c_040",
        question: "Which of the following is NOT a way AI is being used to benefit humanity?",
        options: [
            "A. In healthcare, AI interprets scans for early detection of cancer and eye disease",
            "B. In crime: to identify criminals before they commit a crime",
    ...
    {
        id: "aig202c_041",
        question: "How can prompt engineering help improve the performance of AI models?",
        options: [
            "A. By generating random prompts for training data",
            "B. By ensuring prompts elicit relevant and coherent responses",
    ...
    {
        id: "aig202c_042",
        question: "A Machine Learning technique that helps in detecting outliers in data is:",
        options: [
            "A. Clustering",
            "B. Classification",
            "C. Anomaly Detection",
    ...
    {
        id: "aig202c_043",
        question: "Monica is a writer looking to improve her storytelling using an LLM for creative writing prompts. Which feature of a prompt engineering tool would be most beneficial?",
        options: [
            "A. Iteratively refining prompts based on initial LLM story outputs",
    ...
    {
        id: "aig202c_044",
        question: "Which of the following are unstructured data sources?",
        options: [
            "A. Email",
            "B. Blog posts",
    ...
    {
        id: "aig202c_045",
        question: "How do digressions affect the flow of a conversation between a user and a chatbot?",
        options: [
            "A. Digressions help maintain focus on the original topic",
            "B. Digressions create confusion and frustration by shifting away from the query",
    ...
    {
        id: "aig202c_046",
        question: "How can adjusting the temperature parameter affect the output of generative AI models?",
        options: [
            "A. Increasing temperature leads to more conservative responses",
            "B. Decreasing temperature leads to more diverse and creative responses",
    ...
    },
    {
        ...
        options: [
            "A. The process of creating prompts to guide the output of generative AI models",
            "B. The process of training generative AI models using large datasets",
    ...
    {
        id: "aig202c_048",
        question: "How does the interview pattern approach enhance interaction with generative AI models?",
        options: [
            "A. By focusing on a conventional prompting approach",
            "B. By hierarchically structuring a prompt or query",
    ...
    {
        id: "aig202c_049",
        question: "A metaverse platform with generative AI capabilities will allow you to access _____, which is not possible with other generative AI tools.",
        options: [
            "A. Virtual avatars",
            "B. Synthetic images",
    ...
    {
        id: "aig202c_050",
        question: "Which of these activities is not required for a neural network to synthesize human voice?",
        options: [
            "A. Generate audio data and run it through the network to validate it",
            "B. Deconstruct sentences to decipher the context of use",
    ...
    {
        id: "aig202c_051",
        question: "What do Abu Dhabi National Oil Company (ADNOC) hope that the use of AI will help them achieve?",
        options: [
            "A. To understand their business better and retain knowledge",
            "B. To eliminate knowledge transfer",
    ...
    {
        id: "aig202c_052",
        question: "What is the primary goal of incorporating 'digressions' in chatbot conversations?",
        options: [
            "A. To strictly follow pre-defined conversation paths",
            "B. To limit user interaction choices",
    ...
    {
        id: "aig202c_053",
        question: "Which aspect of chatbot development focuses on implementing 'digressions'?",
        options: [
            "A. Hardware optimizations",
            "B. Conversation flow and engagement",
    ...
    {
        id: "aig202c_054",
        question: "What is the primary viewpoint on ethical concerns with AI systems?",
        options: [
            "A. Something that can't be mitigated",
            "B. Not genuinely troubling, and the concern of very few AI experts",
    ...
    {
        id: "aig202c_055",
        question: "How do chatbots use dialog management to guide conversations with users?",
        options: [
            "A. By ignoring user input",
            "B. By following a predefined sequence of interactions based on user responses",
    ...
    {
        id: "aig202c_056",
        question: "Which of the following is NOT an attribute of Machine Learning?",
        options: [
            "A. Takes data and answers as input to create rules for the model",
            "B. Takes data and rules as input to develop an algorithm",
    ...
    {
        id: "aig202c_057",
        question: "What is the primary goal of prompt engineering tools?",
        options: [
            "A. To optimize the creation of prompts for generative AI models",
            "B. To create applications for language model experiments",
    ...
    {
        id: "aig202c_058",
        question: "Which aspect of chatbot development does the 'Dialog' module emphasize?",
        options: [
            "A. Software development methodologies",
            "B. Managing conversational flow and responses",
    ...
    {
        id: "aig202c_059",
        question: "Which of the following is a benefit of having an integrated AI system in a call center environment?",
        options: [
            "A. Reducing costs",
            "B. Eliminating the need for human agents",
    ...
    {
        id: "aig202c_060",
        question: "Imagine you are using the Chain-of-Thought approach to teach a generative AI model how to solve a mathematical problem. What is the key component of a prompt in this approach?",
        options: [
            "A. A prompt includes only a question without an answer",
            "B. A prompt includes a list of formulae to solve the question",
    ...
    {
        id: "aig202c_061",
        question: "AI is the fusion of many fields of study. Which of these fields, along with Computer Science, plays a role in the application of AI?",
        options: [
    ...
    {
        id: "aig202c_062",
        question: "Which of the following is NOT an example of an entity for a travel chatbot?",
        options: [
            "A. Destination",
            "B. Departure time",
            "C. GreetUser",
    ...
    },
    {
        ...
        options: [
            "A. Adapting prompts based on user feedback",
            "B. Using pre-trained language models without any prompts",
    ...
    {
        id: "aig202c_064",
        question: "What are 'context variables' in the context of artificial intelligence and chatbots?",
        options: [
            "A. Variables used to store the state or context of a conversation",
            "B. Variables that represent the emotions of the chatbot",
    ...
    {
        id: "aig202c_065",
        question: "What is the primary purpose of a chatbot in the field of artificial intelligence?",
        options: [
    ...
    {
        id: "aig202c_066",
        question: "Which one of these jobs COULD NOT be taken by a robot with AI?",
        options: [
            "A. Bank clerk",
            "B. Doctor",
    ...
    {
        id: "aig202c_067",
        question: "Which of the following would be a GOOD question to ask to test if you are talking to a human or a computer?",
        options: [
    ...
    {
        id: "aig202c_068",
        question: "What type of generative AI capability does a large language model primarily exhibit?",
        options: [
            "A. Image generation",
            "B. Audio generation",
            "C. Text generation"
    ...
    {
        id: "aig202c_069",
        question: "Generative AI models can _____ the training data to create unique content.",
        options: [
    ...
    },
    {
        ...
        options: [
            "A. Cognitive systems can only translate small volumes of audio data into text",
            "B. Cognitive systems derive precise answers using a rigid decision tree",
    ...
    {
        id: "aig202c_071",
        question: "Which of the following tasks would an AI be able to perform the LEAST successfully?",
        options: [
    ...
    {
        id: "aig202c_072",
        question: "What is the primary definition of a chatbot among the following options?",
        options: [
    ...
    {
        id: "aig202c_073",
        question: "Which field of AI involves interpreting visual information from images or videos?",
        options: [
    ...
    {
        id: "aig202c_074",
        question: "A prompt is any input or _____ that helps generative AI models produce relevant and logical responses.",
        options: [
    ...
    {
        id: "aig202c_075",
        question: "Which of the following is a scenario where an AI is being asked to make an ETHICAL decision?",
        options: [
            "A. A self-driving car must choose to avoid one of two pedestrians",
            "B. A voice assistant schedules an appointment on the user's calendar",
    ...
    {
        id: "aig202c_076",
        question: "Which one of these ways is NOT how AI learns?",
        options: [
            "A. Supervised Learning",
            "B. Reinforcement Learning",
    ...
    {
        id: "aig202c_077",
        question: "How does the Tree-of-Thoughts approach differ from traditional linear prompting approaches?",
        options: [
            "A. It encourages linear thinking",
            "B. It eliminates all possible routes of thinking",
    ...
    {
        id: "aig202c_078",
        question: "Imagine you are planning a business trip, and you want to use the interview pattern approach to prompt an AI model to assist with itinerary planning. What is the benefit of this approach compared to a static prompt?",
        options: [
            "A. The model will provide a single predetermined itinerary",
            "B. The model will ask for your preferences and adjust the itinerary accordingly",
    ...
    {
        id: "aig202c_079",
        question: "What is one of the potential future impacts of AI in the job market?",
        options: [
            "A. Decrease in demand for skilled professionals",
            "B. Increased job opportunities across all sectors",
    ...
    {
        id: "aig202c_080",
        question: "What does Ethical AI Governance focus on in the development and deployment of AI systems?",
        options: [
            "A. Establishing strict regulations to limit AI capabilities",
            "B. Ensuring ethical guidelines and standards in AI use",
    ...
    {
        id: "aig202c_082",
        question: "How does the streamline mode in PromptPerfect contribute to prompt optimization?",
        options: [
            "A. By selecting a relevant model for prompt optimization",
            "B. By accessing prebuilt prompts as examples",
    ...
    {
        id: "aig202c_083",
        question: "In what way do 'digressions' impact the overall chatbot experience?",
        options: [
            "A. They hinder the conversation flow",
            "B. They provide a natural and varied conversational experience",
    ...
    {
        id: "aig202c_084",
        question: "What is the purpose of evaluating prompt effectiveness in prompt engineering for generative AI?",
        options: [
            "A. To determine computational resources required for generating outputs",
            "B. To assess the relevance and coherence of model outputs from different prompts",
    ...
    {
        id: "aig202c_085",
        question: "If you want precise control over style for manipulating specific features like a pose or facial expression, which tool can help you do that best?",
        options: [
            "A. Stable Diffusion",
            "B. DALL-E",
            "C. Freepik",
    ...
    {
        id: "aig202c_086",
        question: "Why haven't scientists been completely successful when developing AI?",
        options: [
    ...
    {
        id: "aig202c_087",
        question: "How can prompt engineering be used to control the creativity of generative AI models?",
        options: [
            "A. By limiting the vocabulary used in prompts",
            "B. By adjusting the temperature parameter during model generation",
    ...
    {
        id: "aig202c_088",
        question: "Ravi is debating which Generative AI tool to use to improve and index his code. Which tool is best suited?",
        options: [
            "A. DALL-E",
            "B. GitHub Copilot",
            "C. Bard",
    ...
    {
        id: "aig202c_089",
        question: "How do well-implemented 'digressions' contribute to user satisfaction within chatbot interactions?",
        options: [
            "A. By creating predictable conversation patterns",
            "B. By restricting the variety of conversation paths",
    ...
    {
        id: "aig202c_090",
        question: "Which of the following do you need to create to publish a notebook to your GitHub repository?",
        options: [
            "A. Apps",
            "B. Profile",
            "C. Access token",
    ...
    {
        id: "aig202c_091",
        question: "What are 'context variables' in chatbot conversations?",
        options: [
            "A. User authentication methods",
            "B. Temporary data storage during conversations",
    ...
    {
        id: "aig202c_092",
        question: "How do chatbots use context variables and slots to maintain context during a conversation?",
        options: [
            "A. By ignoring the user's input",
            "B. By storing information about the user's preferences and previous interactions",
            "C. By generating random responses",
            "D. By terminating the conversation after a set number of interactions"
        ],
        answer: [1],
    ...
    {
        id: "aig202c_093",
        question: "What mindset did Woodside notice amongst its workers after introducing an AI system?",
        options: [
            "A. Retiring workers resented their knowledge being reduced to a computer system",
            "B. Younger workers resisted contributing to the AI knowledge base",
    ...
    {
        id: "aig202c_094",
        question: "How do 'digressions' contribute to chatbot functionality?",
        options: [
            "A. By ignoring user inputs",
            "B. By maintaining rigid conversation structures",
    ...
    {
        id: "aig202c_095",
        question: "What is the role of transfer learning in generative AI?",
        options: [
            "A. Training models from scratch for each new task",
    ...
    {
        id: "aig202c_096",
        question: "Which of the following is a key advantage of using generative AI in content creation?",
        options: [
            "A. Increased need for human intervention",
            "B. Ability to produce large volumes of content quickly",
    ...
    {
        id: "aig202c_097",
        question: "What is a common use case for generative AI in the entertainment industry?",
        options: [
            "A. Managing financial transactions",
            "B. Creating realistic special effects for movies",
    ...
    {
        id: "aig202c_098",
        question: "What is the purpose of fine-tuning in generative AI models?",
        options: [
            "A. To completely retrain the model from scratch",
    ...
    {
        id: "aig202c_099",
        question: "Which of the following is a challenge when deploying generative AI in real-world applications?",
        options: [
            "A. Guaranteed accurate outputs in all scenarios",
            "B. Potential for generating biased or inappropriate content",
    ...
    {
        id: "aig202c_100",
        question: "How does generative AI contribute to personalized education?",
        options: [
            "A. By limiting access to educational resources",
            "B. By creating tailored learning materials for individual students",
    ...
    {
        id: "aig202c_101",
        question: "What is the role of attention mechanisms in large language models?",
        options: [
            "A. To reduce the model's memory usage",
            "B. To focus on relevant parts of the input data during processing",
    ...
    },
    {
        ...
        options: [
            "A. A model that classifies emails as spam or not spam",
            "B. A model that generates realistic human faces",
    ...
    {
        id: "aig202c_103",
        question: "How does generative AI assist in drug discovery?",
        options: [
            "A. By slowing down the research process",
            "B. By generating potential molecular structures for new drugs",
    ...
    {
        id: "aig202c_104",
        question: "What is a potential ethical issue with using generative AI for content creation?",
        options: [
            "A. Increased content production speed",
            "B. Potential for creating misleading or false information",
    ...
    {
        id: "aig202c_105",
        question: "What is the benefit of using few-shot learning in generative AI?",
        options: [
            "A. It requires no training data",
            "B. It allows models to learn from a small number of examples",
    ...
    {
        id: "aig202c_106",
        question: "Which of the following is a key component of a transformer model used in generative AI?",
        options: [
            "A. Decision trees",
    ...
    {
        id: "aig202c_107",
        question: "What is the primary challenge of ensuring fairness in generative AI outputs?",
        options: [
            "A. Lack of computational power",
            "B. Inherent biases in training data",
    ...
    {
        id: "aig202c_108",
        question: "How does generative AI support creative industries like music composition?",
        options: [
            "A. By limiting creative outputs to pre-existing templates",
            "B. By generating original melodies and harmonies",
